...
public final class Client extends javax.swing.JFrame {
    ...
    private void cargarContenido(String fileType, javax.swing.JList<String> list) {
        try (Socket contentSocket = new Socket(Logiin.SERVER_ADDRESS, Logiin.SERVER_PORT); PrintWriter out = new PrintWriter(contentSocket.getOutputStream(), true); BufferedReader in = new BufferedReader(new InputStreamReader(contentSocket.getInputStream()))) {
