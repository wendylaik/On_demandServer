...
public final class InterServer extends javax.swing.JFrame {
    ...
    public InterServer(Flujocliente clientCommunication, List<String> roles) {
        initComponents();
        loadAllContent();
   ...
   public void cargarContenido(String fileType, javax.swing.JList<String> list) {
...
private void cargarArchivo(String fileType) {
    ...
    public javax.swing.JList<String> getJList(String fileType) {
        switch (fileType) {
            case "Documents":
                return DocList;
            case "Videos":
  ...
  private void abrirArchivo(String fileName, String fileType) {
    ...
    private void initComponents() {
        ...
        DocList1 = new javax.swing.JList<>();
        botonDocumentos1 = new javax.swing.JButton();
        ...
        botonDocumentos.setText("Desconectar user");
        ...
        DocList1.setBackground(new java.awt.Color(57, 57, 57));
        DocList1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                DocList1MouseClicked(evt);
            }
        });
        jScrollPane4.setViewportView(DocList1);

        botonDocumentos1.setBackground(new java.awt.Color(2, 40, 55));
        botonDocumentos1.setForeground(new java.awt.Color(255, 255, 255));
        botonDocumentos1.setText("Cargar Docs");
        botonDocumentos1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botonDocumentos1ActionPerformed(evt);
            }
        });
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addGap(62, 62, 62)
                .addComponent(botonDocumentos1, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)
...
private String getSelectedFileType() {
    ...
    private void DocList1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DocList1MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_DocList1MouseClicked

    private void botonDocumentos1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonDocumentos1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_botonDocumentos1ActionPerformed

    // Variables declaration - do not modify//GEN-BEGIN:variables
    public javax.swing.JList<String> DocList;
    public javax.swing.JList<String> DocList1;
    ...
    private javax.swing.JButton botonDocumentos1;
