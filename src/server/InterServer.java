...
private void cargarContenido(String fileType, javax.swing.JList<String> list) {
        try (Socket contentSocket = new Socket("25.65.94.55", 8181); // IP y Puerto del servidor
...
private void cargarArchivo(String fileType) {
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            ...
            try (Socket uploadSocket = new Socket("25.65.94.55", 8181); // IP y Puerto del servidor
 ...
 private void abrirArchivo(String fileName, String fileType) {
        ...
        try (Socket downloadSocket = new Socket("25.65.94.55", 8181); // IP y Puerto del servidor
